...
class DatabaseSeeder extends Seeder {
    ...
    private function seedUsers() {
        ...
        $user1->email = 'alexmaciasortega@gmail.com';
        $user1->password = bcrypt('carnual26');
        $user1->save();
        $user2 = new User;
        $user2->name = 'Luis';
        $user2->email = 'luisibañez@gmail.com';
        $user2->password = bcrypt('1234');
        $user2->save();
        $user3 = new User;
        $user3->name = 'Ana';
        $user3->email = 'anajana@gmail.com';
        $user3->password = bcrypt('anajana');
        $user3->save();
    }
    ...
    private function seedMovies_Users() {
        DB::table('movies_users')->delete();
        $favoritas1 = new MoviesUser();
